...
export const chart_bar = (activity: any[], id: string) => {
    ...
    //     groups = groups.map(group => group = i)
    ...
    const mousemove = function (event: { layerX: number; layerY: number; }, d: { kilogram: any; calories: any; }) {
        tooltip
    ...
    groupBar.forEach(bar => {
        ...
        let transform = bar.getAttribute("transform")
